...
try{
	...
	String where_query="Where user_id = '" + user_id + "' AND isTrash='false' AND ";
	...
	while(rs.next()){
		...
		String friend_group_name = rs.getString("friend_group_name");
		...
		job.put("friend_group_name", friend_group_name);
